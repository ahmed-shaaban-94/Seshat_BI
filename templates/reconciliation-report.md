...
- **Filled instance:** `docs/worked-examples/retail-store-sales.md` section 5
  (penny-exact reconciliation across the fact measures; unmatched fact rows on the `-1`
  unknown members). The worked example is a filled instance, never the universal schema.
