...
and a semantic or metric question to `bi-dax-knowledge` /
`retail-kpi-knowledge`. Findings are advisory evidence for a named human; a
clean review never grants approval or a readiness pass.
