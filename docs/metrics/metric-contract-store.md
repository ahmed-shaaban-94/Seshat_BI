...
in `../worked-examples/retail-store-sales.md`; it is cited, never inlined here (Principle VII).
...
- C086 as the filled-instance reference (not the schema): `../worked-examples/retail-store-sales.md`
