...
1. **Delivery shape (verb vs skill)** -- RESOLVED: skill over a library function (applying the ratified Option B policy, 2026-07-07). This feature adds no new verb. Sibling-tension note (verified): the peer explorer/passport verbs were added by spec 120 (created 2026-07-11, AFTER the ratification), so they are NOT grandfathered -- they are a verb-parity counter-argument surfaced for the ratifier, who may override to a verb.
