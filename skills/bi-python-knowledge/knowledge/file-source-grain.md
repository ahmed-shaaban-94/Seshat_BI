...
- C086 (a retail pharmacy example) is a DB-landed worked example, not a file source -- a filled
  instance, never the universal schema: `docs/worked-examples/retail-store-sales.md`.
