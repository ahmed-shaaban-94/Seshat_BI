...
- [ ] **DAX handoff ready** — handoff notes state the fact/dimension fields, grain,
      additivity, filters, and open ambiguities for the DAX layer.
...
Record one of: **Ready for DAX handoff** · **Planned** · **Needs business definition
(blocked on: …)**.
