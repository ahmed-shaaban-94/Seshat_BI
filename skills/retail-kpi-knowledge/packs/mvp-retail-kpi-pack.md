...
**Included KPIs**
First 20 recommended KPIs. Only the 10 with seeded contracts are **live**; the other 10
are **planned/deferred** and must not be treated as ready.
...
| 11 | Net Sales Growth % | — | Planned/deferred |
| 12 | Average Basket Size (Units) | — | Planned/deferred |
...
| 18 | YTD Net Sales | — | Planned/deferred |
...
need: a target fact (17), inventory snapshots (15, 16), fiscal calendar (18), and
load/quality metadata (19, 20).
...
Executive summary tiles + a Sales Performance page. Show only the 10 live KPIs on the
...
**Handoff notes**
Hand the 10 live contracts to the DAX/semantic layer with their business-terms formulas,
