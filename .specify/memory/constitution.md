...
- Templates MUST use placeholders and cite the worked example as the filled
  ...
  `docs/worked-examples/retail-store-sales.md` for what a fully filled set looks like
  (validated against the ADR defaults on a live database).
...
`docs/worked-examples/retail-store-sales.md` (the filled instance).
